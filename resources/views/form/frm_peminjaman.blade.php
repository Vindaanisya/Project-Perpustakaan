    ...
    @else
        ...
        @csrf
            ...
            <div class="box-header">
                ...
                <div class="box-tools">
                <button type="button" class="btn btn-success btn-flat" data-toggle="modal" data-target="#m-buku">Tambahkan Buku</button>
                </div>
            </div>
                    ...
                    <!--Menampilkan Data Anggota -->
                        @foreach($buku as $rsBuku)
                            <tr>
                                ...
                                <td>{{ $rsBuku->judul }}</td>
                                <td>
                                    <button class="btn btn-success btn-xs btn-flat" onclick="add_buku('{{ $rsBuku->no_induk_buku }}','{{ $rsBuku->judul }}')" data-dismiss="modal">PILIH</button>
                                </td>
                            </tr>
                        @endforeach
